  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <nav className="relative z-10 mx-auto flex max-w-7xl flex-row items-center justify-between px-8 py-6">
        ...
        <Button
          variant="glass"
          className="liquid-glass h-auto rounded-full px-6 py-2.5 text-sm text-foreground transition-transform hover:scale-[1.03]"
        >
          Begin Journey
        </Button>
      </nav>
      ...
      <section className="relative z-10 flex min-h-[calc(100vh-96px)] flex-col items-center justify-center px-6 py-[90px] pb-40 pt-32 text-center">
        ...
        <Button
          variant="glass"
          className="liquid-glass animate-fade-rise-delay-2 mt-12 h-auto cursor-pointer rounded-full px-14 py-5 text-base text-foreground transition-transform hover:scale-[1.03]"
        >
          Begin Journey
        </Button>
      </section>
